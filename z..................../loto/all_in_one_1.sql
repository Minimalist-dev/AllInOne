...
--
-- Servidor: localhost
-- Tiempo de generación: 14-07-2021 a las 23:24:58
...
--
-- Estructura de tabla para la tabla `ChatDePara`
--

CREATE TABLE `ChatDePara` (
  `id` bigint(20) NOT NULL,
...
--
-- Volcado de datos para la tabla `ChatDePara`
--

INSERT INTO `ChatDePara` (`id`, `de`, `para`, `fecha`, `fechaFinalizada`) VALUES
(1, '1', '5', '2021-04-21 19:28:14', '2021-04-22 06:28:07'),
(2, '1', '2', '2021-04-21 19:34:07', '2021-04-22 06:29:28'),
(4, '5', '2', '2021-04-21 19:49:50', NULL),
(5, '5', '3', '2021-04-21 20:02:36', NULL),
(6, '3', '1', '2021-04-21 20:16:29', '2021-04-22 06:33:27');
...
INSERT INTO `Chats` (`id`, `de`, `para`, `mensaje`, `fecha`) VALUES
(1, '1', '5', 'Hello. How are you today?', '2021-04-21 19:28:14'),
(2, '1', '2', 'Hello. How are you today?', '2021-04-21 19:34:10'),
(3, '5', '2', 'Hello. How are you today?', '2021-04-21 19:49:50'),
(4, '5', '3', 'Hello. How are you today?', '2021-04-21 20:02:36'),
(5, '3', '1', 'Hello. How are you today?', '2021-04-21 20:16:29'),
(6, '3', '1', '?', '2021-04-21 20:16:38'),
(7, '3', '1', '?', '2021-04-21 20:16:39'),
(8, '5', '1', 'Hey! I\'m fine. Thanks for asking!', '2021-04-21 20:33:09'),
(214, '1', '3', '1', '2021-04-22 06:27:59'),
(215, '1', '2', '2', '2021-04-22 06:28:03'),
(216, '1', '5', '3', '2021-04-22 06:28:07'),
(217, '1', '2', '3', '2021-04-22 06:29:27'),
(218, '1', '3', '2', '2021-04-22 06:33:27');
...
INSERT INTO `Compartidas` (`id`, `yo`, `usuario`, `publicacion`, `compartida`, `fecha`) VALUES
(42, '1', '3', '5', '36', '2021-04-15 23:20:21'),
(44, '1', '5', '7', '38', '2021-04-18 04:05:55');
...
(212, '1', '7', '2021-04-18 04:05:32', NULL, NULL, NULL, '2021-04-18 03:07:33', '2021-04-18 04:05:35'),
(213, NULL, NULL, NULL, NULL, '1', '36', '2021-04-18 04:00:38', NULL),
(214, '1', '38', '2021-04-18 04:19:29', NULL, '1', '38', '2021-04-18 04:19:31', NULL),
(215, '1', '4', '2021-04-18 04:23:12', NULL, '1', '4', '2021-04-18 04:23:16', NULL),
(216, '5', '36', '2021-04-18 16:05:00', NULL, NULL, NULL, NULL, NULL),
(217, '5', '6', '2021-04-18 16:05:06', NULL, NULL, NULL, NULL, NULL);
...
(402, '2021-05-05', '1158', '05 16 19 20 28 30', '09', '08'),
...
(87, '2021-05-13', '20:18:25', 'Entrada', 'Nueva', '1.00');
...
--
-- Indices de la tabla `ChatDePara`
--
ALTER TABLE `ChatDePara`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `ChatDePara`
--
ALTER TABLE `ChatDePara`
